...
In this paper, we propose a system that satisfy the outlined requirements, including privacy and verifiability.

\paragraph Thus, the paper makes the following contributions:
\begin{itemize}
    \item It describes i-voting system powered by Stellar blockchain network and its limited smart contract capabilities, and it's limited smart contract techniques.
    \item It describes practical aspect of blockchain i-voting where user is completely abstracted from technology used underneath, thus no knowledge of wallets and keypairs are needed.
    \item It describes blind-signature over ed25519 and transactions batching to achieve voter privacyhow voter privacy is achieved using blind-signatures over ed25519 scheme, with conjunction of transaction batching.
    \item It describes how organizer is protected from malicious users by cut-and-choose technique.
\end{itemize}
