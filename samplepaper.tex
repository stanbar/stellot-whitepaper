...
In our system, we assumed that Identity Provider and Issuance Server are honest actors. We assumed that we know the total number of eligible voters, and that only eligable voters are able to redeem tokens. The question is how can we know if the authorities doesn't publish falsify number of eliga who is eligable to redeem token  We relay on the fact that Issuance Server won't redeem tokens to bogus voters Identity Provider woncan not 
