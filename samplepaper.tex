...
We decide to make some modification where
Since Stellar uses ed25519 signature scheme which seems to not support blinded signatures, we slightly modify the concept of encrypted signature as a signature on the hash on transaction  
