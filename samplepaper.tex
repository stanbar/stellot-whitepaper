...
\bibiterm{ref_moscow_voting}
P. Gaudry, A. Golovnev: Breaking the Encryption Scheme of the 
Moscow  Internet Voting System.

\bibiterm{ref_verifiability}SoK: Verifiability Notions for E-Voting Protocols
V.eronique Cortier ´
∗
, D.avid Galindo†
, R.alf Kusters ¨
