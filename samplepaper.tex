...
And here is the place where a variety of different Blockchain platforms comes out offering something unique. While most conservative Blockchain like Bitcoin and Ethereum put on Security and Decentralization, others offer higher Scalability on the cost of Decentralization and Security. Stellar uses its own consensus protocol called Federated Byzantine Agreement(FBA) ~\cite{mazieres2015stellar}, which is decentralized variant of Byzantine Agreement consensus protocol, which is .   is one of such solutions. 
