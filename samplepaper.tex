...
Voter start interactive session with Issuer where they proceed  exchange transactions and   Chaum Blind Signature \cite{blindsignatureschaum}. This process consists of 6 steps:
\begin{itemize}
\item Voter request Issuer for blinding key
\end{itemize}
Transaction is then blinded in order to follow Chaum Blind Signature scheme \cite{blindsignatureschaum}.
