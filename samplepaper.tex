...
\textbf{privacy}: to na kogo zagłosowałem powinien być sekretem dla wszystkich. Miejsca gdzie będę szukał odpowiedzi to Homomorphic encryption, Mix-Networks oraz Secure multi-party computation. Może uda się to osiągnąć dzięki [Shamir's Secret Sharing].
