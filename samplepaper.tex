...
There is one issue with this technique. The Issuer has to sign blinded document. Malicious voter could give the Issuer any kind of document, and the Issuer would sign it blindly. In order to protect from this kind of vulnerability, we use cut-and-choose technique.method proposed in \cite{applied_cryptography}. 
