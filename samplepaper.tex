...
Requirements that robust e-voting system should satisfy are as follows:
\begin{itemize}
\item \textbf{Immutability}: No one can change thieir mind after vote is made.
...
\item \textbf{Coercion resistance}: It should be illegal to exchangesell votes.
