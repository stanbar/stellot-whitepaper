...
[Breaking the Encryption Scheme of the Moscow Internet ~\cite{ref_breaking_moscow_voting}
\url{https://eng.ambcrypto.com/ethereum-blockchain-voting-sets-precedent-with-moscow-elections/} Voting](https://eng.ambcrypto.com/ethereum-blockchain-voting-sets-precedent-with-moscow-elections/)


\url{https://www.computerworld.com/article/3430697/why-blockchain-could-be-a-threat-to-democracy.html} 
[Why blockchain-based voting could threaten democracy](https://www.computerworld.com/article/3430697/why-blockchain-could-be-a-threat-to-democracy.html)

\url{https://blog.enigma.co/secret-voting-smart-contracts-with-enigma-a-walkthrough-5bb976164753} Secret Voting
[Secret Voting](https://blog.enigma.co/secret-voting-smart-contracts-with-enigma-a-walkthrough-5bb976164753)

[Veryfying Identity](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3375436)
...
Blockchain is famous for being very slow. Ethereum creator Vitalik Buterin claims that Blockchains face [trillema](https://github.com/ethereum/wiki/wiki/Sharding-FAQ#this-sounds-like-theres-some-kind-of-scalability-trilemma-at-play-what-is-this-trilemma-and-can-we-break-through-it) which allows them to choose only two of three properties: Decentralization, Security and Scalability. And here is the place where variety many Blockchain platforms comes out offering something unique. While most conservative Blockchain like Bitcoin and Ethereum put on Security and Decentralization, others offers higher Scalability on the cost of Decentralization and Security. Stellar is one of such solutions. 
At the date of writing, Ethereum is able to process 15 transactions per second (TPS).
...
\bibitem{ref_breaking_moscow_voting}
Author, P. Gaudry, Author A. Golovnev: Breaking the Encryption Scheme of the Moscow Internet Voting System
