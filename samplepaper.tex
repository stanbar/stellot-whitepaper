...
\begin{itemize}
\item IssuerVoter generate random number \textit{r} and send it back to voter.
\item User picks two random numbers \textit{a} and \textit{b} \textit{r} and send it back to voter.request Issuer for blinding key
