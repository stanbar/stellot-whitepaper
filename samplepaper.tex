...
Breaking the Encryption Scheme of the Moscow Internet ~\cite{gaudry2019breaking} Secret Voting ~\cite{tam_2018} On Collusion ~\cite{buterin_2019}

\section{E-Voting system requirements}
\textbf{privacy}: relacja głosująca-oddany głos musi pozostać tajemnicą, tak by wyborcy mogli wyrażać swoją wolę bez obawy o
bycie zastraszonym. Miejsca gdzie będę szukał odpowiedzi to Homomorphic encryption, Mix-Networks oraz Secure multi-party computation. Może uda się to osiągnąć dzięki [Shamir's Secret Sharing].
...
\textbf{Universal verifiability}: Each user should be able to calculate election results on thier own.Un-reusability}: 
\textbf{end-to-end verifiability}: każdy wyborca powinien być w stanie zweryfikować wyniki wyborów oraz to czy jego głos został uwzględniony w wyborach.
