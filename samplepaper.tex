...
\textbf{Verifability}: Each user should be able to verify if his vote has been counted correctly.
...
\textbf{Authorization}: Only votes made by eligable votes are taken into account.
