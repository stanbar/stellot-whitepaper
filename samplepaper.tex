...
% - production-ready: jest to rozwiązanie które ma sens wdrażania już dziś. Inne publikacje operają się albo na bitcoinie (który nie jest przystosowany do tworzenia na nim alpikacji tego typu), Eethereum który aktualnie nie radzi sobie ze skalowalnością w dodatku (z tego co się orientujewydaje mi się), że nie da się zaimplementować algorytmu ślepego podpisu w smart contractcie bez ujawniania klucza prywatnego, więc platformy smart contractowe nic tu nie dają. , Co więcej inne publikacje zakładają, że kazdy głosujący posiada portfel bitcoinowy, co moim zdaniem jest mrzonką. Ten system nie wymaga od użytkownika żadnej wiedzy.
albo są na tyle abstrakcyjne że nie mówią o żadnym konkretnym blockchainie. Ten system 
