...
% How to solve it ?
% It differ from token locking because it can be done from arbitrary account. Well, token transfer too. We need channel account that won't be connected with us.% lack better word for "capable of breaking privacy", any suggestions ?
