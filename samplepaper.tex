...
%
\begin{abstract}
In this paper, we propose an production-ready and privacy-first e-voting system based on decentralized Stellar Blockchain network. We argue that proposedsuch system satisfy all requirements stated for robust e-voting systems such as scalability, transparency, verifiability, and voter anonymity/privacy. has potential to be used in large 
